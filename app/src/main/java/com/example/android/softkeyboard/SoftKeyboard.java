...
public class SoftKeyboard extends InputMethodService 
    ...
    private void setLatinKeyboard(LatinKeyboard nextKeyboard) {
        if (nextKeyboard == mQwertyKeyboard) {
            mInputView.setSymbolsShift(false);
            mInputView.setSymbols(false);
        }
        else if (nextKeyboard ==  mSymbolsKeyboard) {
            mInputView.setSymbols(true);
            mInputView.setSymbolsShift(false);
        }
        else if(nextKeyboard == mSymbolsShiftedKeyboard) {
            mInputView.setSymbolsShift(true);
            mInputView.setSymbols(false);
        }
